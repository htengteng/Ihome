    ...
    $.ajax({
        ...
        success:function(rsp){
            ...
            for (var i = 0; i < rsp.data.length; i++) {
                var house_li = '<li class="house-item">';
                house_li += '<a href="/house/detail/?house_id=' + rsp.data[i].id + '"><img src=' + rsp.data[i].images[0] + '></a>';
                house_li += '<div class="house-desc">';
                house_li += '<div class="landlord-pic"><img src="' + rsp.data[i].images[0] + '"></div>';
                house_li += '<div class="house-price">￥<span>' + rsp.data[i].price + '</span>/晚</div>';
                house_li += '<div class="house-intro">';
                house_li += '<span class="house-title">' + rsp.data[i].title + '</span>';
                house_li += '<em>出租' + rsp.data[i].room_count + '间 -' + rsp.data[i].max_days + '次入住 - ' + rsp.data[i].address + '</em>';
                house_li += '</div></div></li>';
                console.log(house_li)
                house_str += house_li
            }
            console.log(house_str)
            $('.house-list').append(house_str)
        },
