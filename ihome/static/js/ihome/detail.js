...
$(document).ready(function () {
    ...
    $.get('/house/detail/' + house_id + '/', function (msg) {
        ...
        $('#htt').attr('src', msg.house_info.user_avatar);
        // console.log(msg.house_info.user_avatar)


        var image_str = '';
        for (var i = 0; i<msg.house_info.images.length;i++){
            img_li = ''
            console.log(msg.house_info.images[0])
            img_li += '<li class="swiper-slide"><img src='+msg.house_info.images[i]+'></li>'
            image_str += img_li
        }
